...
const CatalogExplorer: React.FC<CatalogExplorerProps> = ({ onOpenCatalog }) => {
  ...
  const catalogs = [
    { id: '1', year: '2025', title: 'Каталог: Корпусная мебель 2025', label: 'MEBELSON 2025', size: 'Большой PDF', color: 'red' },
    { id: '2', year: '2024', title: 'Каталог КУХНИ', label: 'KITCHEN 2024', size: '12 Mb', color: 'dark' },
    { id: '3', year: '2024', title: 'Каталог СПАЛЬНИ', label: 'BEDROOM 2024', size: '8.5 Mb', color: 'gray-dark' },
