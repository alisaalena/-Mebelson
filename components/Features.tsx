...
const Features: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Добавляйте видео, аудио и прямые ссылки на покупку товаров прямо в страницы вашего каталога.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Отслеживайте, какие страницы читают дольше всего, и на какие ссылки кликают ваши пользователи.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Текст в ваших каталогах индексируется поисковиками, привлекая органический трафик.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Используйте встроенный Gemini AI для написания описаний товаров и улучшения заголовков.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="features" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Все, что нужно для успеха</h2>
