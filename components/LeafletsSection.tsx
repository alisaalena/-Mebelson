...
const LeafletsSection: React.FC<LeafletsSectionProps> = ({ onOpenLeaflet }) => {
  const leaflets = [
    { title: 'Стиль Nordic: Уют Севера', info: 'Готовые решения для гостиной', pdfUrl: '/upload/leaflets/nordic.pdf', img: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&q=80&w=400' },
    { title: 'Лофт: Индустриальный шик', info: 'Тренды в дизайне кухонь', pdfUrl: '/upload/leaflets/loft.pdf', img: 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&q=80&w=400' },
    { title: 'Детская Dream: Территория игр', info: 'Безопасность и эргономика', pdfUrl: '/upload/leaflets/kids_dream.pdf', img: 'https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&q=80&w=400' },
  ];
